...
void main(){
    ...
    int ran, boolBrazo, sacados, encolados;
    ...
    switch(ran){//Se crean piezas de un brazo aleatorio
        ...
        i1++;
        encolados = encolar(boolBrazo,brazoA,lcc);
            break;
        case 1:
        boolBrazo=generaPieza(brazoB,i2);
        i2++;
        encolados = encolar(boolBrazo,brazoB,lcc);
            break;
        case 2:
        boolBrazo=generaPieza(brazoC,i3);
        i3++;
        encolados = encolar(boolBrazo,brazoC,lcc);
            break;
        case 3:
        boolBrazo=generaPieza(brazoD,i4);
        i4++;
        encolados = encolar(boolBrazo,brazoD,lcc);
            break;
    }
    ...
    if(ran==1){
        sacados=rand()%6;
            if(sacados >= encolados){
               for(sacados = encolados; sacados>0; sacados--){
               push(listap,)
               }
            }
            else{
